    ...
    <body> 
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
                ...
                <li id="informational"><a href="informational.php">Informational Games</a></li> 
                <li class="active" id="educational"><a href="educational.php">Educational Games</a></li> 
              </ul>
        ...
        <div class="container-fluid"> 
            <div id="gamesList">
                ...
                $games = array();
                $query = "SELECT * FROM educational_games";
                $result = mysqli_query($link, $query);
                //iterate through games within the game type (educational)
