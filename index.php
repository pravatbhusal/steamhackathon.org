    ...
    <body> 
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
                <li class="active" id="recreational"><a href="index.php">Recreational Games</a></li>
        ...
        <div class="container-fluid"> 
            <div id="gamesList">
                ...
                $games = array();
                $query = "SELECT * FROM recreational_games";
                $result = mysqli_query($link, $query);
                //iterate through games within the game type (recreational)
